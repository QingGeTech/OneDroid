...
import cn.recommender.androiddevtoolbox.databinding.FloatingScrollScreenshotBinding
import cn.recommender.androiddevtoolbox.ui.activity.ScrollScreenshotResultActivity
...
//        screenshot()
    ...
    private fun compositeBitmaps(): String {
        ...
        // 将结果 Mat 转换为 Bitmap
        val mergedBitmap = Bitmap.createBitmap(result.cols(), result.rows(), bitmaps[0].config)
